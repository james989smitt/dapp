document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (typeof window.ethereum !== 'undefined') {
        ...
        try {
            ...
            const options = {
                gasLimit: 285000,  // Pas dit aan op basis van de complexiteit van je contract
            };
            const tx = contractInstance.methods.mintNFT().send({ from: account, value: mintPrice, ...options });
            
            const contractAddress = '0xB83a179bEFBBb08773D2757Bc4D73701A7D1Ba17';
            const contractABI = [
                {
                    "inputs": [
                        {
            ...
            document.getElementById("mintButton").addEventListener("click", async () => {
                ...
                const totalCost = (mintPrice * amount).toString();
                ...
                try {
                    ...
                    document.getElementById("status").innerHTML = `Minting successful! <a href="https://etherscan.io/tx/${txHash}" target="_blank">View on Etherscan</a>`;
